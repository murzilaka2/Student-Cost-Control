...
{
    public partial class annotate_incomes : System.Web.UI.Page
    {
        ...
        private void SaveToDb()
        {
            ...
            Income.Add(new Models.Income(0, DB.GetUserID((string)Session["Authorization"]), Server.HtmlEncode(Name.Text.Trim()), n, currency,
