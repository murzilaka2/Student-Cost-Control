<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="annotate-incomes.aspx.cs" Inherits="Cost_Control.finance.annotate_incomes" %>
                ...
                <div class="dashboard-ecommerce">
                    <div class="container-fluid dashboard-content">
                        <div class="row">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active">Annotate Income</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Indicate Your Income</h5>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="Name" class="col-form-label">Income Name</label>
