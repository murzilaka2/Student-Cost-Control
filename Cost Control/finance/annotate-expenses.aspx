<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="annotate-expenses.aspx.cs" Inherits="Cost_Control.Finance.annotate_expenses" %>
                ...
                <div class="dashboard-ecommerce">
                    <div class="container-fluid dashboard-content">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Indicate Your Expenses</h5>
                                    <div class="card-body">
